...
var department = '';
var registerType = '';
var registerStatus = '';//挂号状态。-1:过期，1:挂号成功
var treatmentStatus = '';//就诊状态0:未就诊，1:已就诊
$(function () {
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#registerRecord').bootstrapTable({
            url: '/api/register/page',         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            columns: [{
                ...
                valign: 'middle',
                formatter: function (value, row, index) {
                    return row.registerStatus == -1 ? "<span class='label label-default'>过期</span>" : "<span class='label label-info'>正常</span>";
                }
            }, {
                ...
                valign: 'middle',
                formatter: function (value, row, index) {
                    return row.treatmentStatus == 1 ? "<span class='label label-success'>已就诊</span>" : "<span class='label label-info'>未就诊</span>";
                }
            }, {
...
$('.registerSearch_3').chosen({disable_search: true, allow_single_deselect: true,}).change(function () {
    registerStatus = $(".registerSearch_3 option:selected").val();
});
$('.registerSearch_4').chosen({disable_search: true, allow_single_deselect: true,}).change(function () {
    treatmentStatus = $(".registerSearch_4 option:selected").val();
});
