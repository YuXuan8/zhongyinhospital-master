...
function getCardIdInfor(command) {
    ...
    $.ajax({
        url: "/api/outpatient/getCardIdInfor",
        type: "post",
...
function changePatientInfor() {
    ...
    $.ajax({
        url: "/api/Patient/changePatientInfor",
        type: "post",
        contentType: "application/json",
...
function refreshQueue() {
    ...
    $.ajax({
        url: "/api/outpatient/getalloutpatientqueue",
        type: "post",
        dataType: "json",
        success: function (data) {
            var html = '';
            $.each(data.data, function (i, value) {
                ...
                html += '<th>' + (i + 1) + '</th>';
                html += '<td>' + value.patientId + '</td>';
                html += '<td>' + value.name + '</td>';
                if (value.status==-1) {
                    //registerId需要加引号，需要用\"转义
                    html += "<td>" + "<button class='btn btn-info mybutton' onclick='restorePatientInfor(\"" + value.id + "\")'>恢复</button>"
                }
                html += ' </tr>'
            });
...
function ProcessLater() {
    ...
    swal({
            ...
            $.ajax({
                url: "/api/outpatient/ProcessLaterMedicalRecord",
                type: "post",
                contentType: "application/json",
...
function restorePatientInfor(registerId) {
    $.ajax({
        url: "/api/outpatient/restorePatientInfor",
        type: "post",
        data: {
...
function addMedicalRecord() {
    ...
    swal({
        ...
        setTimeout(function () {
            $.ajax({
                url: "/api/outpatient/addMedicalRecord",
                type: "post",
                contentType: "application/json",
                data: JSON.stringify(MedicalRecordReqVO),
                success: function (data) {
...
function getMedicalExamination() {
    ...
    $.ajax({
        url: "/api/outpatient/getMedicalExamination",
        type: "post",
        data: {
            "prescriptionNum": prescriptionNum
        },
